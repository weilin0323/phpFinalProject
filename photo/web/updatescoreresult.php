...
<div class="wrap">
    ...
    <div class="content">
		<div class="top"><h1>修改課程評價</h1></div>
		<div class="clear"></div>
	    <div class="innerText"> 
      <?php
$link=@mysqli_connect('localhost','root','jing1030','php');
...
$SQLUpdate="UPDATE classevaluation SET subject='$subject',name='$name',hw='$hw',score2='$score2',score='$score' WHERE ID='$ID'";
...
if($result=mysqli_query($link,$SQL)){
    ...
    echo "<tr><td>"."編號"."</td><td>"."課程名稱"."</td><td>"."授課教授"."</td><td>"."作業"."</td><td>"."評分方式"."</td><td>"."評價"."</td><td>"."修改"."</td><td>"."刪除"."</tr>";
  //  echo "<tr><td>No</td><td>Name</td><td>Gender</td></tr>";
    while($row=mysqli_fetch_assoc($result)){
       echo "<tr>";
       echo "<td>".$row["ID"]."</td><td>".$row["subject"]."</td><td>".$row["name"]."</td><td>".$row["hw"]."</td><td>".$row["score2"]."</td><td>".$row["score"]."</td><td><a href='updatescore.php?ID=".$row['ID']."'>修改</a></td>"."<td><a href='deletescore.php?ID=".$row['ID']."'>刪除</a></tr>";
    }
    echo "</table>";
}
?>
