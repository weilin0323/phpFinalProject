    ...
    <div class="content">
        ...
        <div class="class">
           <?php 
			...
			echo "<table width=580 height=45 cellpadding=3 border=2>";
			echo "<tr>"."<td>"."課程名稱"."</td>"."<td>"."修課學年"."</td>"."<td>"."開課系所"."</td>"."<td>"."授課老師"."</td>"."<td>"."推薦指數"."</td>"."<td>"."評分方式"."</td>"."<td>"."考題與作業類型"."</td>"."<td>"."其他補充"."</td>"."</tr>";
			if($result=mysqli_query($link,$SQL)){
			while($row=mysqli_fetch_assoc($result))  //從資料集取得的陣列，索引值只能是 "字串" 
			echo "<tr>"."<td>".$row["subject"]."</td>"."<td>".$row["classyear"]."</td>"."<td>".$row["department"]."</td>"."<td>".$row["name"]."</td>"."<td>".$row["score"]."</td>"."<td>".$row["score2"]."</td>"."<td>".$row["hw"]."</td>"."<td>".$row["other"]."</td>"."</tr>";
			 }
			echo "</table>";
			...
			//header("location:classevaluation.php")
			// unset($_POST["classYear"]);
