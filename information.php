...
<div class="wrap">
   ...
   <?php
        ...
        if($name){
            if($name==楊書成){
                echo"<div class='picture'><img src='https://scontent.fkhh1-1.fna.fbcdn.net/v/t1.0-9/37997844_10211770979741103_1326883945135996928_n.jpg?_nc_cat=100&_nc_ht=scontent.fkhh1-1.fna&oh=6bac747287ce3241c897f0a1cc96c534&oe=5D86B28E' alt=''></div>";
            }
         echo "<div class='info'>";
